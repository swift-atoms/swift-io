...
// ===----------------------------------------------------------------------===//
//
// This source file is part of the swift-io-primitives open source project
//
// Copyright (c) 2026 Coen ten Thije Boonkkamp and the swift-io-primitives project authors
